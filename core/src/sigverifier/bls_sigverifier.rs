...
use {
    crate::{
        ...
        sigverify_stage::{SigVerifier, SigVerifyServiceError, VerifyPacketBatchesStats},
    },
...
impl SigVerifier for BLSSigVerifier {
    ...
    fn verify_batches(
    ...
    ) -> (Vec<ConsensusMessage>, VerifyPacketBatchesStats) {
        ...
        let stats = VerifyPacketBatchesStats {
