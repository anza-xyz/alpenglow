use {
    assert_matches::assert_matches, ed25519_zebra::ed25519::signature::Signer as EdSigner,
...
// https://docs.rs/ed25519-dalek/1.0.1/src/ed25519_zebra/secret.rs.html#167
fn generate_keypair() -> ed25519_zebra::Keypair {
    use rand::RngCore;
    let mut rng = rand::thread_rng();
    let mut seed = [0u8; ed25519_zebra::SECRET_KEY_LENGTH];
    rng.fill_bytes(&mut seed);
    let secret =
        ed25519_zebra::SecretKey::from_bytes(&seed[..ed25519_zebra::SECRET_KEY_LENGTH]).unwrap();
