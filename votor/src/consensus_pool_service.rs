...
use {
    ...
    agave_votor_messages::{
        consensus_message::{Block, Certificate, ConsensusMessage, HighestFinalizedSlotCert},
...
impl ConsensusPoolService {
    ...
    fn process_pending_safe_to_notar(
        ...
        let highest_finalized = consensus_pool.highest_finalized_slot();
        ...
        pending_safe_to_notar.retain(|&(slot, block_id)| {
            ...
            let Some(_location) = ctx.blockstore.get_block_location(slot, block_id) else {
...
mod tests {
    ...
    impl Default for TestContext {
        fn default() -> Self {
            ...
            let cluster_info = Arc::new(ClusterInfo::new(
                ContactInfo::new_localhost(&my_pubkey, 0),
                Arc::new(my_keypair),
                SocketAddrSpace::Unspecified,
            ));
            let consensus_pool = ConsensusPool::new_from_root_bank(cluster_info, &root_bank);
    ...
    fn test_send_produce_block_event() {
        ...
        let mut pool_ctx = ConsensusPoolContext {
            ...
            repair_event_sender: crossbeam_channel::unbounded().0,
