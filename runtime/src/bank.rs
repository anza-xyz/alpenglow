...
use {
    ...
    solana_votor_messages::consensus_message::{Block, Certificate, CertificateMessage},
    std::{
...
pub struct Bank {
    ...
    alpenglow_genesis: Option<(Block, CertificateMessage)>,
}
...
impl Bank {
    ...
    pub fn get_alpenglow_genesis(&self) -> Option<(Block, CertificateMessage)> {
        self.alpenglow_genesis.clone()
    }

    pub fn set_alpenglow_genesis(
        &mut self,
        genesis_block: Block,
